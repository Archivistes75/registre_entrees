...
packages = c("tidyverse","viridis", "shiny", "plotly", "data.table", "stringr", "ggplot2", "gganimate", "ggthemes", "hrbrthemes", "dygraphs", "gmodels", "forcats", "e1071", "mlbench", "tm", "SnowballC", "htmlwidgets", "kableExtra", "gifski")
...
data$nature <- as.character(data$nature)
...
if (data[2,]$nomArch == "Archives municipales d'Avignon"){
